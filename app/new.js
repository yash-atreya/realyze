...
class App extends Component {
  ...
  helloAudioMessagesRef = this.storageRef.child('AudioMessages/hello.mp3');
  onUpload = async () => {
    var uploadFile = this.state.file;
    console.log('uploadFile', uploadFile);
    this.helloAudioMessagesRef
      .putFile('sdcard/hello.mp3')
  ...
  onDownload() {
    ...
    } file://Realyze/AudioMessages_sent/${new Date()}.mp3`;
    const task = firebase
      .storage()
      .ref('AudioMessages/hello.mp3')
